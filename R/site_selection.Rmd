...
```
# Plan of attack
# Convert fine scale veg map to points
# crop points by fesm shapefile
# assign severity to points using fesm raster
# filter points by severity
```{r}
#r <- "../Data/Raw/rainfine.tif"
#rfortif<- raster(r)

#This seemed like the right thing but took forever to run
rfor <- rasterToPoints(rfortif)
